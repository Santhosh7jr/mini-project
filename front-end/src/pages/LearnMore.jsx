...
export default function LearnMore() {
  ...
  return (
    <div className="bg-[#E9E5DF] min-h-screen">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-[#0A66C2] to-[#004182] py-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            How Karigo Works
          </h1>
          <p className="text-[#EAF4FD] text-lg md:text-xl mb-8 max-w-3xl mx-auto">
      ...
      <div className="px-6 py-16">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-[#191919] text-center mb-12">
            Why Choose Karigo?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              <div
                key={i}
                className="bg-[#FFFFFF] border border-[#D0D7DE] rounded-xl p-6 text-center hover:shadow-lg transition"
              >
      ...
      {/* Step by Step */}
      <div className="bg-[#FFFFFF] px-6 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="text-center">
                <div className="w-16 h-16 rounded-full bg-gradient-to-r from-[#0A66C2] to-[#004182] flex items-center justify-center text-white font-bold text-2xl mb-4 mx-auto">
                  {item.step}
                </div>
      ...
      {/* CTA Section */}
      <div className="px-6 py-16">
        <div className="max-w-4xl mx-auto bg-gradient-to-r from-[#0A66C2] to-[#004182] rounded-2xl p-12 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Ready to Experience Better Service?
          </h2>
          <p className="text-[#EAF4FD] mb-8 text-lg">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              ...
              className="bg-[#FFFFFF] text-[#191919] px-8 py-3 rounded-lg font-semibold hover:shadow-lg transition"
            >
              Find Service Providers
            </button>
            <button
              onClick={() => navigate("/")}
              className="border-2 border-[#FFFFFF] text-white px-8 py-3 rounded-lg font-semibold hover:bg-white/10 transition"
            >
              Go Back Home
            </button>
          </div>
      ...
      {/* FAQ Section */}
      <div className="px-6 py-16 bg-[#FFFFFF]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={i}
                className="bg-[#E9E5DF] border border-[#D0D7DE] rounded-lg p-6"
              >
                <h3 className="text-lg font-semibold text-[#191919] mb-2">
                  {item.q}
                </h3>
                <p className="text-[#666666]">{item.a}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="px-6 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-[#191919] mb-6">Need Help?</h2>
          <p className="text-[#666666] text-lg mb-8">
            Our customer support team is available 24/7 to assist you.
          </p>
          <div className="flex flex-wrap justify-center gap-8">
            <div className="bg-[#FFFFFF] border border-[#D0D7DE] rounded-lg p-6 flex-1 min-w-[200px]">
              <div className="text-3xl mb-2">📞</div>
              <p className="text-[#666666] font-semibold">Call Us</p>
              <p className="text-[#191919] text-lg">7019827091</p>
            </div>
            <div className="bg-[#FFFFFF] border border-[#D0D7DE] rounded-lg p-6 flex-1 min-w-[200px]">
              <div className="text-3xl mb-2">📧</div>
              <p className="text-[#666666] font-semibold">Email Us</p>
              <p className="text-[#191919] text-lg">support@karigo.com</p>
            </div>
            <div className="bg-[#FFFFFF] border border-[#D0D7DE] rounded-lg p-6 flex-1 min-w-[200px]">
              <div className="text-3xl mb-2">💬</div>
              <p className="text-[#666666] font-semibold">Chat With Us</p>
              <p className="text-[#191919] text-lg">9 AM - 9 PM Daily</p>
            </div>
          </div>
        </div>
      </div>
